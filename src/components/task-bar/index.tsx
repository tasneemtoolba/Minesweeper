...
const TaskBar = () => {
  ...
  return (
    <div
      className={clsx(
        "z-[999] window fixed bottom-0 left-0 w-full flex items-center justify-between gap-1 fsh !px-2 !py-1 dark:brightness-75",
        ui == "xp" &&
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {/* <Help /> */}
        <SoundSwitch />
        <a href="https://github.com/zerosoul/ohminesweeper.online" className="mx-2" target="_blank">
